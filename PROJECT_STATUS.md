...
| 16 | Phase 3 §3.1.E — Appointment reminder cron |  |  |
...
| 19 | Phase 3 §3.1.C — OpenAI symptom checker |  |  |
| 20 | Phase 4 — Half-built features (subscriptions, reschedule, notes, support tickets, system logs, reviews CRUD, GPS pharmacies, scheduled medication reminders, pagination) |  |  |
