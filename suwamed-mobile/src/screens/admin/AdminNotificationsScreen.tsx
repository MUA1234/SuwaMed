...
const AdminNotificationsScreen: React.FC = () => {
  ...
  const TYPE_COLORS: Record<string, string> = {
    ...
    const {
        ...
        markAllAsRead, removeNotification, isLoading, setLoading,
    ...
    const handleLongPress = (item: any) => {
        Alert.alert(t('admin.deleteNotification'), t('admin.removeNotificationConfirm'), [
    ...
    const tabs: { key: FilterTab; label: string }[] = [
        ...
        { key: 'unread', label: `${t('admin.unread')} (${unreadCount})` },
                ...
                ListEmptyComponent={
                    <View style={styles.emptyState}>
                        ...
                        <Text style={styles.emptySubtitle}>
                            {activeTab === 'unread' ? t('admin.allCaughtUp') : t('admin.noNotificationsToShow')}
                        </Text>
                    </View>
                }
            />
