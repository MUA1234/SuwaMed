...
const styles = StyleSheet.create({
    ...
    countBadge: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#F3F4F6', alignItems: 'center', justifyContent: 'center' },
    countBadgeAlert: { backgroundColor: '#FEF2F2' },
    ...
    avatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#10B981', alignItems: 'center', justifyContent: 'center', marginRight: spacing.md },
    ...
    pendingBadge: { backgroundColor: '#FFFBEB', paddingHorizontal: spacing.sm, paddingVertical: 2, borderRadius: 10 },
    ...
    rejectBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FEF2F2', borderRadius: borderRadius.sm, paddingVertical: spacing.sm, borderWidth: 1, borderColor: '#FECACA', gap: 4 },
